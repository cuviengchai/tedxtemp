      ...
      <div id="tedx_body">
        <Head>
          ...
          <meta
            ...
            content="vG0fl4beH0zBzva-O48fr36I4vuPh7kRxa_VwguUT1w"
          />
          <meta
            name="viewport"
            content="initiali-scale=1.0, width=device-width"
          />
          <link rel="icon" href="static/icons/tedx.ico" />
          <meta
            name="description"
            content="TEDxChareonkrung คือการรวมตัวของกลุ่มคนที่เชื่อว่า ‘พลังความคิด’ สามารถสร้างแรงขับอันแรงกล้าเพื่อพัฒนา ‘กรุง’ ของเราให้ ‘เจริญ’ ยิ่งขึ้น"
          />
          ...
          <meta
            property="og:image"
            content="http://s3-ap-southeast-1.amazonaws.com/tedxcharoenkrung/tedx_charoenkrung.jpg"
          />

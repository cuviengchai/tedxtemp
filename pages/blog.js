      ...
      >
        <div id="tedx_blog_container">
          <Content
            ...
            enabledHover={false}
            fromBlog={true}
            lng={this.props.router.query.lng}
          />
          <div className="desc_content_container">
            <h1 className="topic">{this.getContent().content.topic}</h1>
            <h1 className="topic_extend">
              {this.getContent().content.topic_extend}
            </h1>
            <span className="separator bottom" />
            <div
              className="main_content"
              dangerouslySetInnerHTML={{
                __html: this.getContent().content.desc
              }}
            />
            <span className="separator bottom" />
              ...
              {this.findBefore().idx != -1 ? (
                <Link
                  ...
                  href={{
                    pathname: "/blog",
                    query: {
                      uid: this.findBefore().before.uid,
                      lng: this.props.router.query.lng
                    }
                  }}
                >
...
export default withRouter(
  translate(["blog"], { i18n, wait: process.browser })(Blog)
);
